import { InterpolationFunction, map } from '../tweening/index.ts';
import { Signal, SignalContext } from './SignalContext.ts';
import { SignalExtensions, SignalValue } from './types.ts';
import { isReactive, modify } from './utils.ts';
